#ifndef _OKCALLS64_H
#define _OKCALLS64_H
static int LANG_CV[256] = {0,1,5,9,11,12,21,59,63,89,158,231, 8, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
...
static int LANG_PV[256] = { 0,1,13,16,59,89,97,231,SYS_open, SYS_set_thread_area, SYS_brk, SYS_read,
...
static int LANG_JV[256] = { 0,2,3,4,5,9,10,11,12,13,14,21,56,59,89,97,158,202,218,231,273,257, 
...
static int LANG_RV[256] = { 0,1,2,3,4,5,9,10,12,13,14,16,21,22,56,59,72,97,98,107,108,131,158,202,218,231,273
...
static int LANG_BV[256] = { 0,1,2,3,4,5,8,9,10,12,13,14,16,21,33,39,59,63,72,79,97,102,104,107,108,110,111,158,231,
...
static int LANG_YV[256] = { 0,1,2,3,4,5,6,8,9,10,11,12,13,14,16,21,59,78,79,89,97,102,104,107,108,158,202,218,231,257,273
...
static int LANG_PHV[256] = { 0,1,2,3,4,5,6,8,9,10,11,12,13,14,16,21,59,79,97,158,202,218,231,257,273,
...
static int LANG_PLV[256] = {0,1,2,3,4,5,8,9,10,12,13,14,16,21,59,72,89,97,102,104,107,108,158,202,218,231,273,
...
static int LANG_CSV[256] = {0,1,2,3,4,5,8,9,10,11,12,13,14,16,21,24,41,42,56,59,63,72,78,79,89,97
...
static int LANG_OV[256] = { 158, 4, 102, 191, SYS_access, SYS_brk, SYS_close,
...
static int LANG_BASICV[256] = { 101, 54, 122, 175, 174, 240, 311, 258, 243, 6, 197,
...
static int LANG_SV[256] = { 1, 23, 100, 61, 22, 6, 33, 8, 13, 16, 111, 110, 39, 79,
